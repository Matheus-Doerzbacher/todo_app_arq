...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, nome: $nome, email: $email, password: $password, dataCriacao: $dataCriacao)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, nome, email, password, dataCriacao);
...
abstract class _User implements User {
  const factory _User(
      ...
      required final DateTime dataCriacao}) = _$UserImpl;
